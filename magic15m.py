...
bb_length = 17  # Periodo por defecto para Bandas de Bollinger
bb_mult = 2.2  # Multiplicador por defecto para Bandas de Bollinger
atr_length = 12  # Periodo por defecto para ATR
ma_trend_length = 50  # Periodo por defecto para MA de tendencia
tp_multiplier = 3  # Multiplicador por defecto para Take Profit
